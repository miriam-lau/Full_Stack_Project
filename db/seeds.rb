...
grocery14 = Grocery.create(category: "", name: "Plastic Cup", quantity: 12, unit: "", user_id: guest.id, purchased: false)
grocery15 = Grocery.create(category: "", name: "Plastic Ware", quantity: 1, unit: "", user_id: guest.id, purchased: false)
grocery16 = Grocery.create(category: "", name: "Napkin", quantity: 1, unit: "", user_id: guest.id, purchased: false)
...
recipe1 = Recipe.create(name: "Fig, Melon and Ham Salad", serving: 6,
  ...
  image_url: "http://res.cloudinary.com/miriam-lau/image/upload/c_scale,w_300/v1497915033/recipe1_ic7rgg.jpg", due_date: "none",
  user_id: guest.id)
...
recipe2 = Recipe.create(name: "Spinach and Artichoke Dip", serving: 4,
  ...
  image_url: "http://res.cloudinary.com/miriam-lau/image/upload/c_scale,w_300/v1497915112/recipe2_inj3wq.jpg", due_date: "none",
  user_id: guest.id)
...
recipe3 = Recipe.create(name: "Guacamole", serving: 4,
  ...
  image_url: "http://res.cloudinary.com/miriam-lau/image/upload/c_scale,w_300/v1497915210/recipe3_oy80yb.jpg", due_date: "none",
  user_id: guest.id)
...
recipe4 = Recipe.create(name: "Oven-Fried Buffalo Wings", serving: 6,
  ...
  image_url: "http://res.cloudinary.com/miriam-lau/image/upload/c_scale,w_300/v1497915338/recipe4_cmdgv7.jpg", due_date: "none",
  user_id: guest.id)
...
recipe5 = Recipe.create(name: "Chinese Tea Eggs", serving: 6,
  ...
  image_url: "http://res.cloudinary.com/miriam-lau/image/upload/v1497915426/recipe5_cmkdfd.jpg", due_date: "none",
  user_id: guest.id)
...
recipe6 = Recipe.create(name: "Mac and Cheddar Cheese", serving: 4,
  ...
  image_url: "http://res.cloudinary.com/miriam-lau/image/upload/c_scale,w_300/v1497915471/recipe6_a29fop.jpg", due_date: "none",
  user_id: guest.id)
...
recipe7 = Recipe.create(name: "Fettuccine Alfredo", serving: 4,
  ...
  image_url: "http://res.cloudinary.com/miriam-lau/image/upload/c_scale,w_300/v1497915520/recipe7_i5gphd.jpg", due_date: "none",
  user_id: guest.id)
...
recipe8 = Recipe.create(name: "Chicken Pot Pie", serving: 4,
  ...
  image_url: "http://res.cloudinary.com/miriam-lau/image/upload/c_scale,w_300/v1497915579/recipe8_dakqxn.jpg", due_date: "none",
  user_id: guest.id)
...
recipe9 = Recipe.create(name: "Ultra-Smashed Cheeseburger", serving: 1,
  ...
  image_url: "http://res.cloudinary.com/miriam-lau/image/upload/c_scale,w_300/v1497915622/recipe9_zir4vb.jpg", due_date: "none",
  user_id: guest.id)
...
recipe10 = Recipe.create(name: "Strawberry Shortcake", serving: 5,
  ...
  image_url: "http://res.cloudinary.com/miriam-lau/image/upload/c_scale,w_300/v1497915703/recipe10_pcitml.jpg", due_date: "none",
  user_id: guest.id)
...
recipe11 = Recipe.create(name: "Caramel Apples", serving: 8,
  ...
  image_url: "http://res.cloudinary.com/miriam-lau/image/upload/c_scale,w_300/v1497915740/recipe11_lil9xr.jpg", due_date: "none",
  user_id: guest.id)
...
recipe12 = Recipe.create(name: "Mexican Wedding Cookies", serving: 10,
  ...
  image_url: "http://res.cloudinary.com/miriam-lau/image/upload/c_scale,w_300/v1497915802/recipe12_sn70fp.jpg", due_date: "none",
  user_id: guest.id)
