...
const milliliter = ["milliliter", "milliliters", "millilitre", "millilitres",
    "ml", "cc", "mL"];
...
const milligram = ["milligram", "milligrams", "milligramme", "milligrammes",
    "mg"];
const gram = ["gram", "grams", "gramme", "grammes", "g"];
const kilogram = ["kilogram", "kilograms", "kilogramme", "kilogrammes", "kg",
    "kgs"];
const millimeter = ["millimeter", "millimeters", "millimetre", "millimetres",
    "mm"];
const centimeter = ["centimeter", "centimeters", "centimetre", "centimetres",
    "cm"];
const meter = ["meter", "meters", "metre", "metres", "m"];
const inch = ["inch", "inches", "in"];
const foot = ["foot", "feet"];

export const allMeasurements = [teaspoon, tablespoon, fluidounce, gill, cup,
